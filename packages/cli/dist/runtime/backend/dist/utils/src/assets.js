...
import { getCacheDir, getDataDir, getLogsDir, getProfilesFilePath, getTempDir, getConfigFilePath } from './dataDir';
/**
 ...
 */
export async function assetDir() {
    return getDataDir();
}
/**
 ...
 */
export async function profilesPath() {
    return getProfilesFilePath();
}
/**
 * Get path for logs directory
 */
export async function logsDir() {
    return getLogsDir();
}
/**
 ...
 */
export async function writeAssetFile(filename, content) {
    const filePath = path.join(getDataDir(), filename);
...
export class AssetManager {
    ...
    static async getScriptPath(filename) {
