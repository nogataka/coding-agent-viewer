 ...
 */
export function makePathRelative(targetPath, basePath) {
 ...
 */
function normalizeMacOSPrivateAlias(inputPath) {
 ...
 */
export async function getCanonicalPath(inputPath) {
    try {
 ...
 */
export function isPathWithin(targetPath, parentPath) {
 ...
 */
export function getRelativePathBetween(fromPath, toPath) {
 ...
 */
export async function isDirectory(inputPath) {
    try {
 ...
 */
export async function isFile(inputPath) {
    try {
        const stats = await fs.stat(inputPath);
        return stats.isFile();
    }
 ...
 */
export function findCommonParent(paths) {
    if (paths.length === 0) {
        return '';
    }
    if (paths.length === 1) {
 ...
 */
export async function createImagesDir(worktreePath) {
 ...
 */
export function getImagesDir(worktreePath) {
 ...
 */
export function getTempFilePath(prefix = 'temp', extension = '') {
