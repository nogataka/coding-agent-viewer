export declare enum ToolResultValueType {
    MARKDOWN = "markdown",
    JSON = "json"
}
...
export declare enum CommandExitStatusType {
    EXIT_CODE = "exit_code",
    SUCCESS = "success"
}
...
export declare enum MessageBoundary {
    SPLIT = "split",
...
export declare function hasEntryIndex(metadata: unknown): metadata is MetadataWithEntryIndex;
